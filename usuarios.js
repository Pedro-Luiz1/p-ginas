/* ==========================================================================
   usuarios.js — Comportamento da tela "Usuários" (Carnegie Imóveis)
   - Iniciais automáticas nos avatares (tabela + rodapé da sidebar)
   - Mostrar/ocultar senha no formulário
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  var toggleBtn = document.getElementById('senhaToggle');
  ...
  function updateCountLabel(visibleCount) {
    ...
    if (visibleCount === totalCount) {
      countLabel.textContent = totalCount + (totalCount === 1 ? ' usuário cadastrado' : ' usuários cadastrados');
    } else {
      countLabel.textContent = visibleCount + ' de ' + totalCount + ' usuários';
    }
  }
